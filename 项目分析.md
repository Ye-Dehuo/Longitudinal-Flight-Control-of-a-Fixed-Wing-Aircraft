...
系统共有 4 个闭环极点，包括 2 个实数极点与1对共轭极点
...
单位负反馈系统中，闭环零点等于开环零点，所以闭环零点共有 2 个

$(-2.82, 0)$

$(-0.2, 0)$

位于虚轴附近的闭环极点 $(0.1998, 0)$ 与闭环零点 $(2, 0)$ 距离过近，两者对于系统响应的影响会互相削弱。闭环零点 $(-2.82, 0)$ 距离虚轴相对较远。因此，系统响应主要由剩下的 1 个实数极点与 1 对共轭极点确定

设实数极点为 $P_1 (-1.904, 0)$，对应一阶系统，时间常数 $T = \frac{1}{w} = 0.525 $

设共轭极点为 $P_2(-1.561, 4.418) \ \ \ P_3(-1.561, -4.418)$ ，对应欠阻尼系统，自然频率 $w_{n} = 4.686 $ ，阻尼比 $\zeta = 0.333$
...
开环系统在坐标原点有 1 个极点， 所以系统属 I 型系统，因而系统可以无误差跟踪阶跃信号
